...
from app.schemas.person import PersonPredict, PredictRequestPerson
from core.domain import PersonWithRelations
...
async def predict_person(request: Request, request_predict: PredictRequestPerson):
    ...
    person = PersonWithRelations(name=request_predict.name, user_type=request_predict.user_type,
                                 posts=request_predict.posts,
