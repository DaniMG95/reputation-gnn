...
class GraphDataLoader:
    ...
    def create_graph(self) -> Data:
        ...
        node_mapping = {person.name: i for i, person in enumerate(persons)}
    ...
    def create_subgraph(self, node_names: list[str], numbers_neighbour: int) -> Data:
        persons = self.repository_people.get_persons_by_names(node_names)
        node_mapping = {person.name: i for i, person in enumerate(persons)}
